...
SYSTEM_PROMPT = (
    ...
    "reverse shells, credential dumping, disabling security tooling, or a service "
    "account such as www-data running a shell or admin command. A low anomaly "
    "score with a benign, explainable command is not a threat.\n"
