...
SYSTEM_PROMPT = (
    ...
    "reasoning. Reserve MEDIUM for genuinely unusual activity, and HIGH/CRITICAL "
    "for clear indicators of compromise. A low anomaly score with a benign, "
    "explainable command is not a threat.\n"
